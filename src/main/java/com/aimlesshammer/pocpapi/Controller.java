...
public class Controller {
    ...
    public List<Account> getBalances(@RequestParam("customer-id") String customerId) {
        logger.info(PapiApplication.LOG_ID + ": requesting balances for customer: '{}'", customerId);
        List<Account> accounts = accountService.accounts(customerId);
        logger.info(PapiApplication.LOG_ID + ": returning aggregated balances for customer: '{}', balances: '{}'", customerId, accounts);
        return accounts;
    }
